...
to go
  ...
  [ 
    ask patches in-radius 2 with [status = 2]
    [ 
      set status 3
      set pcolor red 
    ]
...
391
percolated
any? patches with [pxcor = max-pxcor and status = 4]
17
1
11
...
Change the neighborhood from neighbors4 to a large neighborhood and see if the forest ist still save against burning.
