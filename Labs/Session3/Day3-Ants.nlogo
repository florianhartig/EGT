...
to setup
  ...
  [ set size 1        ;; easier to see
    set color yellow      ;; red = not carrying
    set steplength initial-steplength 
    set energy 100
  ]  
  ask n-of 400 patches [set pcolor green]
  reset-ticks
end
...
to go
  ...
  ask turtles[
    ...
    if (energy > 400) [
       hatch 1 [set energy 150 set size 1.5 set steplength steplength + random-normal 0 0.2 ]
       set energy 150
    ] 
...
"" ""
PENS
"default" 0.1 1 -16777216 true "" "histogram [steplength] of turtles"
